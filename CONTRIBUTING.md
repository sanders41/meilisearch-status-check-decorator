...
The best place to start is to check the [issues](https://github.com/sanders41/meilisearch-status-check-decorator/issues)
...
[GitHub markdown](https://docs.github.com/en/free-pro-team@latest/github/writing-on-github). For example:
    ...
    index = Client("http://localhost:7700", "masterKey")
...
```sh
git clone https://github.com/your-user-name/meilisearch-status-check-decorator.git
cd meilisearch-status-check-decorator
git remote add upstream https://github.com/sanders41/meilisearch-status-check-decorator.git
```

This creates the directory meilisearch-status-check-decorator and connects your repository to the upstream (main project) repository.
...
meilisearch-status-check-decorator uses [isort](https://pycqa.github.io/isort/),
...
```sh
# Run isort
poetry run isort meilisearch_status_check_decorator tests

# Run black
poetry run black meilisearch_status_check_decorator tests

# Run flake8
poetry run flake8 meilisearch_status_check_decorator tests
...
[main github page](https://github.com/sanders41/meilisearch-status-check-decorator). You can run tests and see the
...
tox can be used to run both linting, and run the tests in all versions of Python meilisearch-status-check-decorator supports. Note that you will need to have all the verions of Python installed for this to work.
...
After pushing your code to origin it is now on GitHub but not yet part of the meilisearch-status-check-decorator project. When you’re ready to ask for a code review, file a pull request. Before you do, once again make sure that you have followed all the guidelines outlined in this document regarding code style, tests, and documentation.

### Make the pull request

If everything looks good, you are ready to make a pull request. This is how you let the maintainers of the meilisearch-status-check-decorator project know you have code ready to be reviewed. To submit the pull request:
